...
export declare const EXPERIENCE_SCHEMA_VERSION: 1;
export type TrialOutcome = 'worked' | 'partial' | 'failed';
export type RetentionIntent = 'keep' | 'unsure' | 'remove';
export type LoaderHealth = 'active' | 'disabled' | 'failed' | 'loading' | 'missing' | 'pending' | 'unloading' | 'unknown';
...
export type ReceiptStatus = 'received' | 'clustered' | 'confirmed' | 'reported' | 'fix-released' | 'retest-requested' | 'verified' | 'closed';
...
export declare function uploadPayload(record: LocalExperienceRecord): ExperienceEventV1;
