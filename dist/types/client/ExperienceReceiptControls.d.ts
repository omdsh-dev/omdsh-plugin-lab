...
export declare function ExperienceReceiptControls({ view, record, revise, join, cancel, dismiss, surface, }: ExperienceReceiptControlsProps): import("react").JSX.Element;
