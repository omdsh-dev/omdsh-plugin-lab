...
export const PLUGIN_LAB_REMOTE_DESCRIPTORS = [
  ...
  },
  {
    ...
    service: 'pluginLab', namespace: 'pluginLab', method: 'select', invocation: { kind: 'direct' as const },
    scope: { context: 'agent', wire: 'agentId' },
    parameters: [
      {
        name: 'agent', wire: 'agentId', source: 'lookup' as const, lookup: 'agent',
      ...
      {
        name: 'plugin', wire: 'plugin', source: 'json' as const,
        codec: { mode: 'strict' as const, typeSymbol: '@oh-my-dsh/plugin-lab#TrialPluginRef', schema: pluginRef },
      },
    ],
  ...
  },
  {
    ...
    parameters: [
      ...
      },
      {
        ...
        codec: { mode: 'strict' as const, typeSymbol: '@oh-my-dsh/plugin-lab#PluginLabRevision', schema: revision },
      },
    ],
    result: { mode: 'strict' as const, typeSymbol: '@oh-my-dsh/plugin-lab#PluginLabPanelAction', schema: actionResult },
  ...
  },
  {
    ...
    service: 'pluginLab', namespace: 'pluginLab', method: 'cancel', invocation: { kind: 'direct' as const },
    scope: { context: 'agent', wire: 'agentId' },
    parameters: [{
      name: 'agent', wire: 'agentId', source: 'lookup' as const, lookup: 'agent',
      codec: { mode: 'strict' as const, typeSymbol: '@deepseek-ai/dsh-session/types#SessionId', schema: agentId },
  ...
  },
  {
    ...
    service: 'pluginLab', namespace: 'pluginLab', method: 'discard', invocation: { kind: 'direct' as const },
    scope: { context: 'agent', wire: 'agentId' },
    parameters: [
      {
        name: 'agent', wire: 'agentId', source: 'lookup' as const, lookup: 'agent',
      ...
      {
        name: 'eventId', wire: 'eventId', source: 'json' as const,
        codec: { mode: 'strict' as const, typeSymbol: 'string', schema: z.string() },
      },
    ],
    result: { mode: 'strict' as const, typeSymbol: '@oh-my-dsh/plugin-lab#PluginLabPanelAction', schema: actionResult },
  ...
  },
  {
    ...
    service: 'pluginLab', namespace: 'pluginLab', method: 'receipts', invocation: { kind: 'direct' as const },
    scope: { context: 'agent', wire: 'agentId' },
    parameters: [
      {
        name: 'agent', wire: 'agentId', source: 'lookup' as const, lookup: 'agent',
      ...
      {
        name: 'markRead', wire: 'markRead', source: 'json' as const,
        codec: { mode: 'strict' as const, typeSymbol: 'boolean', schema: z.boolean() },
      },
    ],
    result: { mode: 'strict' as const, typeSymbol: '@oh-my-dsh/plugin-lab#ReceiptBoxSnapshot', schema: receiptBoxResult },
